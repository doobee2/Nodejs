...
var app = http.createServer((req, res) => {
    ...
    if(pathname === '/'){
        ...
        fs.readdir('./data', (error, filelist) => {
            ...
            var html = template.HTML(title, list,
                `
                <form action='/create_pro' method='post' style='padding:20px; displat:flex; flex-direction:column;'>
                    <p>제목</p>
                    <input type='text' name='title' placeholder='title' class='textinput'>
                    <p>내용</p>
                    <textarea name='description' placeholder='description' class='textinput' rows='5'></textarea>
